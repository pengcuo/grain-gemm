...
PROJECT = Path('/home/pengcuo/spark/grain-gemm')
sys.path.insert(0, '/home/pengcuo/spark/experiments/grain-llm-prefill-g256')
...
def main():
    ...
    target = ROOT / f'{args.suite}_{m}_{n}_{k}.json'
    if target.exists():
